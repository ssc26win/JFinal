                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form id="exportForm" action="${context_path}/statis/cpadaily/exportData" method="post">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var url = '${context_path}/statis/cpadaily/getListData';
        ...
        if((startTime!=undefined&&startTime!=null&&startTime!='') && (endTime!=undefined&&endTime!=null&&endTime!='')){
            ...
            url= '${context_path}/statis/cpadaily/getListData?startTime=${startTime}&endTime=${endTime}';
