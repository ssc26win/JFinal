        ...
        <div class="col-xs-12">
          <div class="row-fluid" style="margin-bottom: 5px;">
            <div class="span12 control-group">
              <jc:button className="btn btn-primary" permission="/basic/actual"  id="btn-add" textName="添加"/>
              <jc:button className="btn btn-info" id="btn-edit" permission="/basic/actual" textName="编辑"/>
              <jc:button className="btn btn-danger" id="btn-deleteData" permission="/basic/actual" textName="删除"/>
            </div>
          </div>
          <!-- PAGE CONTENT BEGINS -->
  ...
  $(document).ready(function () {
    ...
    $("#grid-table").jqGrid({
      ...
      colModel: [
        ...
        { label: '净用水量（立方米）', name: 'net_water', width: 100, sortable:false},
        { label: '累计用水量（立方米）', name: 'sum_water', width: 100, sortable:false},
        { label: '当前状态', name: 'state', width: 50, sortable:false},
