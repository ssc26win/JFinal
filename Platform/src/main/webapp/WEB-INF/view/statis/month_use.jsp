                                    ...
                                    <div class="col-xs-12">
                                        <form id="exportForm" action="${context_path}/statis/month/exportData" method="post">
                                            ...
                                            <div class="input-group">
                                                日期:
                                                <input type="text" id="startTime" name="startTime" class="form_month" style="width: 65px;"/>~<input type="text" id="endTime" name="endTime" class="form_month"  style="width: 65px;"/>
