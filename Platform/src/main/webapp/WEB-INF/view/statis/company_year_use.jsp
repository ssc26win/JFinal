                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form id="exportForm" action="${context_path}/statis/cpayear/exportData" method="post">
                                            <input type="text" style="display:none"/>
                                            <div class="input-group">
                                                日期（年）:
                                                <input type="number" id="year" name="year" min="2017" style="width: 80px"/>
                                                <select id="type" name="type" style="margin-left: 5px;width: 110px;height: 34px;"><option value="" selected>选择单位类型</option>
                                                </select>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#grid-table").jqGrid({
            url:'${context_path}/statis/cpayear/getListData',
            mtype: "GET",
            datatype: "json",
            colModel: [
