            ...
            <form class="form-horizontal" id="validation-form" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                  <div class="clearfix">
                    <input type="text"  name="title" ${id ne null?'readonly':'' } value="${item.title}" class="col-xs-12 col-sm-6">
                  </div>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="imgUrl">上传图片</label>
                <div class="col-xs-12 col-sm-9">
                  <div class="clearfix">
                    <input type="text"  name="imgUrl" value="${item.imgUrl}" class="col-xs-12 col-sm-6">
                  </div>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-9">
                  <div class="clearfix">
                    <input type="text"  name="status" value="${item.status}" class="col-xs-12 col-sm-6">
                  </div>
                </div>
              </div>
