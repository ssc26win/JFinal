    ...
    $(document).ready(function () {
        ...
        $("#grid-table").jqGrid({
            ...
            colModel: [
                ...
                { label: '地下水埋深（米）', name: 'ground_depth', width: 100, sortable:true},
                ...
                { label: '是否已配套机电设备', name: 'electromechanicsName', width: 150, sortable:false},
                { label: '是否已安装水量计量设施', name: 'calculateWaterName', width: 150, sortable:false},
                { label: '水泵型号', name: 'pump_model', width: 80, sortable:false},
                { label: '水量计量设施类型', name: 'calculateTypeName', width: 100, sortable:false},
                { label: '是否为规模以上地下水水源地的水井', name: 'aboveScaleName', width: 180, sortable:false},
                { label: '所在地貌类型区', name: 'geomorphicTypeName', width: 80, sortable:false},
                { label: '所取用地下水的类型', name: 'groundTypeName', width: 120, sortable:false},
                ...
                { label: '年许可取水量（万立方米）', name: 'water_withdrawals', width: 150, sortable:true}
            ],
            viewrecords: true,
            height: 560,
            rowNum: 20,
