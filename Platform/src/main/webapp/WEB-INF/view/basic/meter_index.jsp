                ...
                <div class="col-xs-12">
                    <div class="row-fluid" style="margin-bottom: 5px;">
                        <div class="span12 control-group">
                            <jc:button className="btn btn-primary" id="btn-add" permission="/basic/meter/save" textName="添加"/>
                            <jc:button className="btn btn-info" id="btn-edit" permission="/basic/meter/save" textName="编辑"/>
                            <jc:button className="btn btn-danger" id="btn-deleteData" permission="/basic/meter/delete" textName="删除"/>
                            <jc:button className="btn btn-warning" id="btn-importData" permission="/basic/meter/importData" textName="导入"/>
                            <jc:button className="btn btn-success" id="btn-exportData" permission="/basic/meter/export" textName="导出"/>
                        </div>
                    </div>
                    <!-- PAGE CONTENT BEGINS -->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#grid-table_meter").jqGrid({
            ...
            datatype: "json",
            colModel: [
                { label: '单位名称', name: 'companyName', width: 280, sortable:false},
        ...
        setTimeout(function () {
            ...
            $("#grid-table_meter").setGridHeight($(window).height()-240);
        }, 500);
