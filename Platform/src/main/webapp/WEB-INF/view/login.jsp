        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    ...
                    <div class="position-relative" style="margin-top:188px;">
                                    ...
                                    <form>
                                        <fieldset>
                                            ...
                                            <div class="block clearfix">
                                                <input type="text" style="width: 198px;vertical-align:middle;"
                                                       placeholder="验证码" name="imgCode" id="imgCode"/>
                                                <img class="yzm-pic" id="img" src="${context_path}/image/getCode"
                                ...
                                <div class="widget-main">
                                    ...
                                    <form>
                                        ...
                                        <fieldset>
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" id="reUsernameEmail"
                                                                   name="reUsernameEmail" class="form-control" readonly
                                                                   value="${reUsernameEmail}"/>
															<i class="ace-icon fa fa-user"></i>
														</span>
                                            </label>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="reSetpassword"
                                                                   name="reSetpassword" class="form-control"
                                                                   placeholder="请输入密码"/>
															<i class="ace-icon fa fa-lock"></i>
														</span>
                                            </label>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="reSetpassword2"
                                                                   name="reSetpassword2" class="form-control"
                                                                   placeholder="请输入确认密码"/>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <button type="button" id="rePwdEmail-btn"
                                ...
                                <div class="widget-main">
                                    ...
                                    <form>
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="email" id="sendrePwdEmail"
                                                                   name="sendrePwdEmail" class="form-control"
                                                                   placeholder="请输入邮箱"/>
                                ...
                                <div class="widget-main">
                                    ...
                                    <form action="sys/">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" id="companyName" name="companyName"
                                                                   class="form-control cnwth" placeholder="请输入单位名称"/>
															<div id="auto_div"></div>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" id="r2password" name="r2password"
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <button type="button" id="regist-btn"
                                                        class="width-65 pull-right btn btn-sm btn-success">
