                ...
                <div class="col-xs-12">
                    <div class="row-fluid" style="margin-bottom: 5px;">
                        <div class="span12 control-group">
                            <jc:button className="btn btn-primary" id="btn-add" permission="/app/law/save" textName="添加"/>
                            <jc:button className="btn btn-info" id="btn-edit" permission="/app/law/save" textName="编辑"/>
                            <jc:button className="btn btn-danger" id="btn-deleteData" permission="/app/law/delete" textName="删除"/>
                            <jc:button className="btn btn-success" id="btn-addImg" permission="/app/law/save" textName="拍照处理"/>
                        </div>
                    </div>
                    <!-- PAGE CONTENT BEGINS -->
