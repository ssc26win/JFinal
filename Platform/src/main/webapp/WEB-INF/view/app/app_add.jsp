                                    ...
                                    <div class="step-content pos-rel" id="step-container">
                                        <div class="step-pane active" id="step1">
                                            <form class="form-horizontal" id="validation-form" method="post">
                                                ...
                                                <%--<div class="form-group">--%>
                                                    <%--<label class="control-label col-xs-12 col-sm-3 no-padding-right"--%>
                                                           <%--for="file_upload">软件包:</label>--%>

                                                    <%--<div class="col-xs-12 col-sm-9">--%>
                                                        <%--<div class="clearfix">--%>
                                                            <%--<div class="cover-area"--%>
                                                                 <%--style="border: 1px solid #e0e0e0;width: 80%;border-radius:5px;padding: 5px 0 0 5px;">--%>
                                                                <%--<div class="cover-hd">--%>
                                                                    <%--<input id="file_upload" name="file_upload"--%>
                                                                           <%--type="file"/>--%>
                                                                    <%--<input id="url" class="cover-input"--%>
                                                                           <%--value="${item.url}" name="url"--%>
                                                                           <%--type="hidden"/>--%>
                                                                <%--</div>--%>
                                                                <%--<p id="upload-tip" class="upload-tip"></p>--%>

                                                                <%--<p id="apkArea" class="cover-bd"--%>
                                                                   <%--style="display: ${action eq 'add'?'none':''}">--%>
                                                                    <%--<a class="vb cover-del" href="#"--%>
                                                                       <%--style="width: 600px;">${item.url}</a>--%>
                                                                <%--</p>--%>
                                                            <%--</div>--%>
                                                        <%--</div>--%>
                                                    <%--</div>--%>
                                                    ...
                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <select name="os" id="os" class="span3">
                                                                <option value="android" ${item.os eq 'android'?'selected':''}>
                                                                    android
                                                                </option>
                                                                <option value="ios" ${item.os eq 'ios'?'selected':''}>
                                                                    ios
                                                                </option>
                                                                <option value="Weixin" ${item.os eq 'Weixin'?'selected':''}>
                                                                    Weixin小程序
                                                                </option>
                                                            </select>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right"
                                                           for="natureNo">自然数版本号:</label>

                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" name="natureNo" id="natureNo"
                                                                   value="${item.natureNo}"/>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right"
                                                           for="linkUrl">外链地址:</label>

                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" name="linkUrl" id="linkUrl"
                                                                   class="col-xs-12 col-sm-6" value="${item.linkUrl }"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right"
                                                           for="linkUrl">微信AppId:</label>

                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" name="wxAppId" id="wxAppId"
                                                                   class="col-xs-12 col-sm-6" value="${item.wxAppId }"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-xs-12 col-sm-3 no-padding-right"
                                                           for="linkUrl">微信Secret:</label>

                                                    <div class="col-xs-12 col-sm-9">
                                                        <div class="clearfix">
                                                            <input type="text" name="wxAppSecret" id="wxAppSecret"
                                                                   class="col-xs-12 col-sm-6" value="${item.wxAppSecret }"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <%--<div class="form-group">--%>
                                                    ...
                                                    <%--<div class="col-xs-12 col-sm-9">--%>
                                                        <%--<div class="clearfix">--%>
                                                            <%--<select name="isForce" id="isForce" class="span3">--%>
                                                                <%--<option value="0" ${item.isForce eq 0?'selected':''}>否--%>
                                                                <%--</option>--%>
                                                                <%--<option value="1" ${item.isForce eq 1?'selected':''}>是--%>
                                                                <%--</option>--%>
                                                            <%--</select>--%>
                                                        <%--</div>--%>
                                                    <%--</div>--%>
                                                    ...
                                                    <%--<div class="col-xs-12 col-sm-9">--%>
                                                        <%--<div class="clearfix">--%>
                                                            <%--<select name="status" id="status" class="span3">--%>
                                                                <%--<option value="0" ${item.status eq 0?'selected':''}>否--%>
                                                                <%--</option>--%>
                                                                <%--<option value="1" ${item.status eq 1?'selected':''}>是--%>
                                                                <%--</option>--%>
                                                            <%--</select>--%>
                                                        <%--</div>--%>
                                                    <%--</div>--%>
