                                        ...
                                        <form id="exportForm" action="${context_path}/report/street/exportData"
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="startTime" name="startTime" value=""
                                                       class="form_date" style="width: 90px;"/>~<input type="text" id="endTime" name="endTime" value=""
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var urlStr = '${context_path}/report/street/getListData?time=' + new Date();
        ...
        $("#btn-chart").click(function () {
            ...
            var url = "${context_path}/report/street/chart?reqType=get&time=" + new Date().getTime();
