                                    ...
                                    <div class="col-xs-12">
                                        <form id="exportForm" action=""
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" id="name" name="name" value="${name}" class="" placeholder="请输入单位名称"
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var url = '${context_path}/report/year/getListData?time=' + new Date().getMilliseconds();
        var sTime = '${date}';
        var eTime = '${date}';
        var companyName = '${companyName}';
        if ((sTime != undefined && sTime != null && sTime != '') && (eTime != undefined && eTime != null && eTime != '')) {
            var sTime = '${date}' + '-01-01 00:00:00';
            var eTime = '${date}' + '-12-31 23:59:59';
            $("#startTime").val(sTime);
            $("#endTime").val(eTime);
            url = '${context_path}/report/year/getListData?time=' + new Date().getMilliseconds();
        ...
        $("#btn_search").click(function () {
            //此处可以添加对查询数据的合法验证
            formAction("${context_path}/report/year");
        });
        $("#btn-chart").click(function () {
            ...
            var url = "${context_path}/report/year/chart?reqType=get&time=" + new Date().getTime();
        ...
        $("#btn-exportData").click(function () {
            //$("#exportForm").submit();
            formAction("${context_path}/report/year/exportData");
        });
    });
