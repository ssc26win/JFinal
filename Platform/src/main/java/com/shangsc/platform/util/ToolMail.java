...
public class ToolMail {
	...
	public static void main(String[] args) {
		...
		String from = "1215665487@qq.com";		// 邮件发送者的地址
		String userName = "1215665487@qq.com";	// 登陆邮件发送服务器的用户名
		String password = "scshang1989";	// 登陆邮件发送服务器的密码

		List<String> to = new ArrayList<String>();			// 邮件接收者的地址
		to.add("ssc26win@126.com");
		
		boolean validate = true;	// 是否需要身份验证
		
		String subject = "标题test111";		// 邮件标题
		String content = "内容test111";		// 邮件的文本内容
		String[] attachFileNames = new String[]{"E:/adcfg.json"};	// 邮件附件的文件名
