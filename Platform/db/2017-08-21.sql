...
) ENGINE=InnoDB AUTO_INCREMENT=37431 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `sys_login_record` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='后台系统登陆记录';
...
INSERT INTO `sys_res` VALUES ('199', '152', '实时数据', null, '/basic/actual', 'fa-list', '1', '1', null, '1', '0');
INSERT INTO `sys_res` VALUES ('200', null, '统计查询', null, '', 'fa-list-alt', '4', '1', null, '1', '0');
INSERT INTO `sys_res` VALUES ('201', '200', '读数查询', null, '/statis/readnum', 'fa-list', '1', '1', null, '1', '0');
INSERT INTO `sys_res` VALUES ('202', '200', '日用水量', null, '/statis/daily', 'fa-list', '2', '1', null, '1', '0');
INSERT INTO `sys_res` VALUES ('203', '200', '月用水量', null, '/statis/month', 'fa-list', '3', '1', null, '1', '0');
INSERT INTO `sys_res` VALUES ('204', '200', '年用水量', null, '/statis/year', 'fa-list', '4', '1', null, '1', '0');
...
) ENGINE=InnoDB AUTO_INCREMENT=4186 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `t_actual_data` (
  ...
  `meter_id` varchar(50) DEFAULT NULL COMMENT '水表表号',
...
CREATE TABLE `t_company` (
  ...
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='单位表';
